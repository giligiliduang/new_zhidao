...
class RegisterForm(FlaskForm):
    username = StringField('', validators=[DataRequired(), Length(max=255),
                                           Regexp('^[a-zA-Z][A-Za-z0-9_.]*$', 0, '必须以数字字母下划线开头')],
...
class ChangePasswordForm(FlaskForm):
    ...
    new_password = PasswordField('', validators=[DataRequired(), EqualTo('confirm_password')],
                                 render_kw={'placeholder': '输入新密码'})
