...
def favorite(username, id):
    ...
    if request.cookies.get('favorite_items') == '2':
        ...
        type = 'question'
        print('favo q')
        return render_template('favorite/favorites.html', user=user, type=type, questions=questions, favorite=favor,
        ...
        type = 'post'
        return render_template('favorite/favorites.html', user=user, type=type, posts=posts, favorite=favor,
                               pagination=pagination)
